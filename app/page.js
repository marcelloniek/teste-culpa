...
const perguntas = [
  "Tenho dificuldades em me perdoar por erros cometidos no passado, mesmo que pequenos ou involuntários.",
  "Costumo me sentir culpado(a) por situações ou eventos, mesmo que não seja claramente responsável por eles.",
  "Acredito frequentemente que sou responsável pela infelicidade ou pelo sofrimento das pessoas ao meu redor.",
  "Tenho problemas em aceitar elogios ou reconhecer minhas próprias qualidades devido ao sentimento frequente de culpa.",
  "Costumo reviver mentalmente erros antigos, sentindo repetidamente vergonha ou remorso por esses acontecimentos.",
  "Já pensei recentemente que não mereço felicidade ou que mereço ser punido(a) severamente por algo que fiz ou deixei de fazer.", // FLAG
  "Sinto-me frequentemente angustiado(a) ou triste por achar que poderia ter feito mais ou melhor em situações passadas.",
  "Minha vida emocional e minha autoestima são profundamente afetadas por pensamentos frequentes de culpa e autoacusação.",
  "Sinto dificuldades em tomar decisões por medo de cometer erros e sentir-me culpado(a) depois.",
  "Evito contato com pessoas ou situações por vergonha ou medo de ser julgado(a) pelos meus erros passados."
];
...
export default function TesteCulpa() {
  ...
  return (
    <div className="max-w-xl mx-auto p-6 bg-gray-100 dark:bg-gray-800 rounded-xl shadow-md text-gray-900 dark:text-gray-100">
      {!resultado ? (
        <>
          <h2 className="text-xl font-semibold mb-2 text-center">Teste de Culpa</h2>
